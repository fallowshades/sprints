...
- personal batches for server feature to process (cohersion)
- page has meta and the path is to href non SPA routing (coupling)

###

to perform batch operation on srr

[layout]

- most simple navbar wo sidebar (user interaction) --> instead dropdown
- transition and enable Context wrapper (state managment server -> client)
...
- clerc middleware for protected ssr pages (prob. match segments)
