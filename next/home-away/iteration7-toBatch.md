...
2. how to support libs with client side dependencies
...
- label/quantity format (quantity: noun)
- quantity
- description (toggle, slice x join) (bool ? true :false)
- amenities <string | null>[] .every --> emptyComponent

[deployable-site]

- leaflet dynamic (for heavy load lazy load)
- find by code
