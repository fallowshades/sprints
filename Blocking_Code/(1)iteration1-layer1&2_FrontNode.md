## iteration 1- layer1 Front node

### Resources needed to add onto tree
...
### Able to find all vertically scalled data wo craches bc error
...
### Able to react to horizontally scalled data without craches
